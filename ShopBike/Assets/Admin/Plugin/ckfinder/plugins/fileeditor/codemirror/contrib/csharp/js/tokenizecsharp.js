...
var tokenizeCSharp = (function () {
    ...
    function jsToken(inside, regexp, source, setInside) {
        ...
        // with punctuation, the type of the token is the symbol itself
            ...
            if (source.equals("*")) { source.next(); return readMultilineComment(ch); }
            else if (source.equals("/")) { nextUntilUnescaped(source, null); return { type: "comment", style: "csharp-comment" }; }
            else if (regexp)
                return readRegexp();
            else
                return readOperator();
