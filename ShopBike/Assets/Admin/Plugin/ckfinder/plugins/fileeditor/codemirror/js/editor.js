...
var Editor = (function () {
    ...
    function SearchCursor(editor, pattern, from, caseFold) {
        ...
        if (from && typeof from == "object" && typeof from.character == "number") {
            ...
            this.pos = {
                from: select.cursorPos(editor.container, true) || topPos,
            ...
            function (reverse, node, offset) {
                ...
                while (true) {
                    ...
                    if (reverse ? offsetB != line.length - match.length : offsetB != match.length)
                        return;
                    return {
                        from: { node: reverse ? pos : node, offset: reverse ? offsetB : offsetA },
